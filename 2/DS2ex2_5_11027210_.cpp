...
public:
    ...
    ~TwoThreeTree() { clearUp(); } // destructor
}; //end TwoThreeTree
...
public:
    AVL_Tree() : fileNO(""), root(NULL) {  } // constructor: do nothing
    ...
    { data.clear(); fileNO.clear(); } // end clearUp
    ~AVL_Tree() { clearUp(); } // destructor: destroy the object
};// class AVL_Tree
